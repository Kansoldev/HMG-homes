        ...
        var r = {
            ...
            n = {
                networkDefs: {
                    ...
                    googleplus: {
                        url:
                            "https://plusone.google.com/_/+1/confirm?hl=en&url=|u|",
                    },
        ...
        var s = {},
            ...
            d = function (t, n, c, a) {
                ...
                (t = t.replace(/ /g, "")),
                    ...
                    e.isFunction(s.onShowResult) &&
                        (resultValue = s.onShowResult.call(
                            this,
                            c,
                            resultValue
                        )),
            ...
            y = function (e) {
                ...
                if (
                    ...
                    throw (
                        ((e.error =
                            "Semantic error: unknown variable '" + s + "'"),
                        "unknownVar")
                    );
                }
            ...
            j = {
                init: function () {
                    return this.each(function () {
                        ($ctx = e(this)),
                            e("[" + s.attribute + "]:not([_jac])", $ctx).each(
                                function () {
                                    if (
                                        (($this = e(this)),
